...
namespace CSLShowMoreLimits
{
    public class Configuration
    {
        ...
        public bool IncludePackageInfoInDump = false;
        public bool IncludeModsInAfterMapDump = true;
        public bool IncludeDisabledModsInDumps = false; 
        public bool EnableGui = true;
        public bool UseAutoRefresh = true;
        public bool AutoShowOnMapLoad = false;
...
//        public uint ResetStatsEveryXMin = 20;  //applies to guimode only
        public float StatsCheckEverySeconds = 60.0f; //~5-6x per second or every ~200 miliseconds (it's not exact but should be close).
